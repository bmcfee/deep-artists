...
#                          n_out=500, activation=T.tanh)
    ...
    layer2 = HiddenLayer(rng, input=layer2_input, n_in=nkerns[0] * (ishape[0] - fshape[0] + 1)/pshape[0] * (ishape[1] - fshape[1] + 1)/pshape[1],
                         n_out=last_layer_size, activation=functools.partial(T.maximum, 0.0))
    ...
    params = layer3.params + layer2.params + layer0.params #+ layer1.params + layer0.params
...
if __name__ == '__main__':
    dsfile = sys.argv[1]
    evaluate_lenet5(dataset=dsfile)
